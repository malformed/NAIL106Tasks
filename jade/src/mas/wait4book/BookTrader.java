...
import mas.wait4book.trader.BuyerLogic;
import mas.wait4book.trader.OfferMaker;
import mas.wait4book.trader.TraderUtils;
        ...
        protected ACLMessage handleRequest(ACLMessage request) throws NotUnderstoodException, RefuseException {
            ...
            try {
                ...
                if (a.getAction() instanceof StartTrading) {
                    ...
                    traderUtils = new TraderUtils(myBooks, myGoal);
        ...
        class TradingBehaviour extends TickerBehaviour {
            ...
            protected void onTick() {
                ...
                try {
                    ...
                    String book_to_buy = traderUtils.buyer().bookToBuy();
                    if (book_to_buy == null) {
                        return;
                    }

                    bi.setBookName(book_to_buy);
                    bis.add(bi);
            ...
            protected ACLMessage handleCfp(ACLMessage cfp) throws RefuseException, FailureException, NotUnderstoodException {
                ...
                try {
                    ...
                    for (int i = 0; i < books.size(); i++) {
                        boolean found = false;
                        for (int j = 0; j < myBooks.size(); j++) {
                            BookInfo mybook = myBooks.get(j);
                            if (mybook.getBookName().equals(books.get(i).getBookName())) {
                                if (traderUtils.canSpare(mybook)) {
                    ...
                    */
                    ...
                    ArrayList<Offer> offers = (new OfferMaker(myBooks, myGoal)).
                                                    makeOffers(sellBooks);
