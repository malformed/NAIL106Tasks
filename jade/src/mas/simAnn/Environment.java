...
public class Environment extends Agent {
    ...
    {
    	try {
			FileHandler fh = new FileHandler("Environment-log.log");
    ...
    private class PrintAgentUtilityBehaviour extends TickerBehaviour {
        ...
        private class AgentUtil implements Comparable<AgentUtil> {
            ...
            public AgentUtil(String agent, double util, boolean goalMet, AgentInfo info) {
                this.agent = agent;
                this.util = util;
        ...
        protected void onTick() {
            ...
            for (String aid : agentBooks.keySet()) {
                ...
                utils.add(new AgentUtil(aid, util, allGoals, ai));
            }
    ...
    private class HandleSendBehaviour extends OneShotBehaviour {
        ...
        public void action() {
            ...
            System.out.println("Transaction: " + sendOrder2);

            logger.log(Level.INFO, "Transaction : {0}", sendOrder1);
            logger.log(Level.INFO, "Transaction : {0}", sendOrder2);
